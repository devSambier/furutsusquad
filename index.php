...
<html lang="en-US">
<head>
<title>Furutsu Squad</title>
<meta charset="utf-8">
<meta name="description" content="Сайт создан для публикации новостей о Furutsu Squad">
...
<meta name="author" content="Furutsu Squad by s.wiftzerx">
<meta name="copyright" content="Furutsu Squad by s.wiftzerx">
...
<body>
<img src="/img/graphics/landing/tyan.png" width="1" height="1" alt="Preload"/>
<img src="/img/videos/onevi.jpg" width="1" height="1" alt="Preload"/>
<img src="/img/videos/onevi2.jpg" width="1" height="1" alt="Preload"/>
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 Вас приветствует сквад под названием "Furutsu". Мы создаем сообщество для эдиторов, в котором участники смогут делиться опытом, инструментами которые они используют в своей работе и находить друзей и сообщников. А также это уютная группа, очень ламповых и душевных людей. Играем, веселимся и просто хорошо проводим время. Присоединяйтесь, ждём каждого!
							</p>
							<div class='landing-btn-container'>
								<a href="https://t.me/+C_rTfmqHDKc0Yzgy">
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/tyan.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									 Новости и так же изменения появляються с задержкой из за того что разработчик не успевает, появились проблемы или же ошибки на сайте? Пишите мне tg: @iichigo7777
								</p>
							</div>
